create database 海产品管理系统 collate Chinese_PRC_CI_AS
go

use 海产品管理系统
go

grant connect on database :: 海产品管理系统 to dbo
go

grant view any column encryption key definition, view any column master key definition on database :: 海产品管理系统 to [public]
go
...
(
    Storehouse_id varchar(20) not null
        constraint PK_Storehouse
            primary key,
...
(
    Classifcation_id   varchar(10) not null
        constraint PK_category
            primary key,
    Classifcation_name nchar(10)
)
go
...
(
    ...
    Supplier_id       varchar(20)
        constraint FK_Goods_Supplier_id
            references Supplier,
    Unit_price        money,
    Stock_quantity    int,
    Order_quantity    int,
    Storehouse_id     varchar(20)
        constraint FK_Goods_Storehouse
...
(
    Order_id       varchar(20) not null
        constraint PK_Sell_order
            primary key,
    Employee_id    varchar(20) not null
        constraint FK_Sell_order_Employee
            references Employee,
    Goods_id       varchar(20) not null
        constraint FK_Sell_order_Goods
            references Goods,
    Order_num      int         not null,
    customers_id   varchar(20) not null
        constraint FK_Sell_order_Customers
            references Customers,
    Transporter_id varchar(20),
    Discount       real,
    Order_date     datetime,
    Send_date      datetime,
    Ariver_date    datetime,
    cost           money,
    kg             int         not null
)
go
...
create procedure sys.sp_add_feature_restriction() as
-- missing source code
go
...
create procedure sys.sp_drop_feature_restriction() as
-- missing source code
go
